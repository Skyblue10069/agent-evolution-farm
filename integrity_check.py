#!/usr/bin/env python3
"""Fast preflight checks for GitHub Actions."""
...
REQUIRED = [
    ...
    "payment_verifier.py", "payout_router.py", "approval_system.py", "rules.json",
]
...
def main():
    ...
    if errors:
        ...
        print("\n".join(errors))
        return 1
    # Ensure no obvious secret material is committed in environment-style files.
    for p in ROOT.glob("*.json"):
        ...
        if any(k in raw for k in ["api_key=", "password=", "secret="]):
            ...
            return 1
    print("Preflight OK: required modules compile and no obvious inline-secret markers found.")
    return 0
